...
2. create a python file with name in form of `TIMESTAMP_description.py` , where `TIMESTAMP` is in the form `YYYYMMDDhhmmss` and `description` is free text (i.e.`20160320145400_description.py`), otherwise migration file won't be found.
